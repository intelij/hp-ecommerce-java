...
public class Cancellation {
    ...
    @XmlElement
    private String cancellationGuid;
    @XmlElement
    ...
    public String getCancellationGuid() {
        return cancellationGuid;
    }

    public void setCancellationGuid(String cancellationGuid) {
        this.cancellationGuid = cancellationGuid;
    }
