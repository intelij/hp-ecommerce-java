...
public class ECommerceClientIT {
    ...
    @Test
    public void testAuthorization() throws HpServerError, HpECommerceException {
    ...
    private Token getToken(ECommerceClient client) throws HpECommerceException, HpServerError {
        Token token = null;
        try {
